...
import { ChevronLeft, ChevronRight, Clock, Type, Hash, Search, Filter, SortAsc } from 'lucide-react';
  ...
  const handleBookClick = async (book) => {
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('current_article_user_id', book.userId);
        localStorage.setItem('current_article_conversation_id', book.conversationId);
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-900">Knowledge Archive</h1>
          <p className="mt-1 text-sm text-gray-500">Access and manage your learning materials</p>
        </div>
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button className="flex items-center space-x-2 px-3 py-2 border border-gray-200 rounded-md text-sm text-gray-600 hover:bg-gray-50">
        ...
        {filteredBooks.length === 0 ? (
          <div className="text-center py-16">
            <div className="bg-gray-50 inline-block p-8 rounded-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {filteredBooks.map((book) => (
              <div
                ...
                className="group relative bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-md transition-all duration-200 cursor-pointer"
              >
